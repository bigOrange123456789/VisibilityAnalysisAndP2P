...
export class SceneManager{
    constructor(renderer, scene, camera, rootPath){
        ...
        this.mesText7 = createElementText(20,150)
        ...
        //     let cylinderList = [];
        //     for(let i=0; i<Object.keys(cylinderJSON).length/10; i++){
        //         let k = Object.keys(cylinderJSON)[i];
        //         let m = cylinderJSON[k];
        //         cylinderList.push(m);
        //     }
        //     console.log(cylinderList);
        //     let cylinder_mesh = CubeModeling(cylinderList);
        //     this.instanceGroup.add(cylinder_mesh);
        // })
    }
    startConnect(){
