...
class MeshSplitter{
    ...
    splitAverage(index){
        ...
        for(let n=0; n<group_num; n++,start_j++){
            ...
            let new_normal_array = new Uint8Array(normal_arr)
            ...
            // object.geometry.setAttribute("normal",new BufferAttribute(new_normal_array,this.stride))
            // object.geometry.setAttribute("uv3",new BufferAttribute(new_uv3_array,this.stride))
