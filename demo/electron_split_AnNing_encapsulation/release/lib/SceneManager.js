...
export class SceneManager {
    constructor() {
        ...
        if(!window.ParamURL.server_ip)window.ParamURL.server_ip="47.100.183.30:4001"
        this.server_ip = "ws://"+window.ParamURL.server_ip//"ws://47.116.5.3:4001";
        console.log("?");
    ...
    loadModelZip(index) {
        ...
        var self = this;
        var url = "assets/" + self.projectName + "/" + index + ".zip";
        ...
        new Promise(function (resolve, reject) {
            ...
            new FileLoader(loader).load(
                "blob:assets/" + self.projectName + "/matrix" + index + ".json",
                (json) => {
