...
class Main: #所有视点,每个视点的可见特征
    def __init__(self,config):
        ...
        self.block2Kernel=self.getKernelView(self.featureAllB,vf0.feature_all0)
        # self.block2Kernel=self.getKernelView(vf0.feature_all0)
        self.getKVCG(
            vf0.initFeature0_({
                "door":1,
                "wall":0,
        ...
        vf0.c["block2Kernel"]=self.block2Kernel

        vf0.c["blocking"]=self.block
        vf0.configCSave()
