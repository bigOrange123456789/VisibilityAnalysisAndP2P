...
export class CrowdManager {
            ...
            window.loadJson(path,data=>{
                ...
                for(let t in data){
                    ...
                    mesh.material.map=new THREE.TextureLoader().load( 
                            "./assets/avatar/textures_sim1/man_linzhou/m0.jpg"
                        )
    ...
    async init(config) {
        ...
        function process(scenes){
            ...
            self.updateMap(crowd,"./assets/avatar/textures_sim1/man_linzhou/m1.jpg",100)
            self.updateMap(crowd,"./assets/avatar/textures_sim1/man_linzhou/m2.jpg",110)
