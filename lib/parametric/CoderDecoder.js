import {
    ...
    FileLoader,
    FrontSide
} from "../../three.js-r129/build/three.module.js"//"../electron/threejs/three.module.js"//"three";//
import * as THREE from "../../three.js-r129/build/three.module.js"//"../electron/threejs/three.module.js"//"three";//
import{Parameter}from "./Parameter.js"
let materialTest = new MeshBasicMaterial( {color: 0xff0000} )
let geometryCylinder=new CylinderGeometry( 1, 1, 2, 8 )
// geometryCylinder.computeVertexNormals()
const geometryCylinder0=new CylinderGeometry( 1, 1, 2, 3 )
// geometryCylinder0.computeVertexNormals()
const geometryCylinder1=new CylinderGeometry( 1, 1, 2, 5 )
// geometryCylinder1.computeVertexNormals()
...
// geometryCube.computeVertexNormals()
...
export class CoderDecoder{
    ...
    static decoder12(code){//该编码方式已经废弃//通过12个数字来描述matrix的编码方式
        ...
        const material = CoderDecoder.getMaterial(color)
