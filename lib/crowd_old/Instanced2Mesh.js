...
export class Instanced2Mesh extends THREE.InstancedMesh {//THREE.InstancedMesh {//new THREE.Points(geometry, material)
    ...
    static async getInstanced2Mesh(
        ...
        if(typeof(crowdGroup.assets[animationUrl])=="undefined")crowdGroup.assets[animationUrl]=await Instanced2Mesh.loadAnimJSON(animationUrl)
