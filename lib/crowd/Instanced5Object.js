...
export class Instanced5Object extends THREE.Object3D {
    constructor(opt) {
        ...
        //     }   
            ...
            //     self.CrowdPoints.add(child.getCrowdPoints())
            // }  
            self.CrowdPoints.add(CrowdPoints.createPoints(this))
        },1000)
    ...
    setPartTypeById(index,partName,meshId){
        this.meshTypeList[partName][index]=meshId
    }
    setPartType(index,partName,meshName){
        const meshId=this
        this.setPartTypeById(index,partName,meshId)
    }
