...
export class CrowdPoints extends THREE.Points{
    constructor(instancedMesh,
        ...
        geometry.setAttribute('moveMaxLength', moveMaxLength)
        geometry.setAttribute('animationStartTime', animationStartTime)
    ...
    update2(instanced5Object){
        ...
        instanced5Object.moveMaxLength//moveMaxLength.array[avatarIndex]
    }
