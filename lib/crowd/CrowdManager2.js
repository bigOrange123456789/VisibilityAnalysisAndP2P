...
import { Instanced5Object } from './Instanced5Object.js'//let Crowd=Pack// 
import * as THREE from "three"
// import{Instanced0Shader}from './Instanced0Shader.js'
import{Instanced0Shader}from './shader2/Instanced0Shader.js'
    ...
    async init(config) {
        ...
        function process(scenes){
            ...
            const crowd = new Instanced5Object({
                ...
                useInstancedBuffer:c.useInstancedBuffer,
